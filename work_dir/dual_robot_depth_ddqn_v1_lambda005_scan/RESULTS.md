...
|---|---:|---:|---:|---:|
| `cyclic_adjacent_pair` | 0.6878 [0.6859, 0.6898] | 0.2361 [0.2298, 0.2423] | 42.50 [41.37, 43.62] | 1.0000 |
| `cyclic_pair` | 0.6900 [0.6876, 0.6924] | 0.2267 [0.2170, 0.2363] | 40.80 [39.06, 42.53] | 1.0000 |
| `full_depth19` | 0.6819 [0.6785, 0.6853] | 0.1486 [0.1441, 0.1531] | 26.75 [25.94, 27.55] | 1.0000 |
| `random_pair` | 0.6830 [0.6768, 0.6893] | 0.2303 [0.2231, 0.2375] | 41.46 [40.16, 42.76] | 1.0000 |
...
```json
{
  ...
  "selected_checkpoints": {
    "full_depth19": "work_dir/dual_robot_depth_ddqn_v1_lambda005_scan/models/full_depth19/seed_20260910/best.pt"
  },
  "depth_audits": {
    "dqn_train": {
      "split": "dqn_train",
