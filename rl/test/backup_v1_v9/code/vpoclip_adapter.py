...
class VPOCLIPAdapter:
    ...
    def from_config(cls, config_path: str, checkpoint_path: str, device: str) -> "VPOCLIPAdapter":
        ...
        invalid_missing = [key for key in missing if not key.startswith("text_encoder")]
        if unexpected or invalid_missing:
            raise RuntimeError(f"Checkpoint mismatch: missing={invalid_missing}, unexpected={unexpected}")
